...
4. Before mutation, derive a readable lowercase kebab-case name, resolve the real target or nearest existing parent, and verify it remains inside `$WORKSPACE_DIR`.
