...
export function buildTurnPrompt(
  ...
  return [
    ...
    "11. Future source adapters must provide their own source-specific posting instructions. Do not assume Slack or any non-Mattermost API details unless the active source context supplies them.",
     ...
     "12a. Do not respond to simple greetings, polite conversation openers (hello, hi, how are you, thank you, etc.), small talk, or casual pleasantries unless they contain an explicit question, request, or instruction directed at you. If you choose to reply, use ONLY FELIX_REPLY — never use intermediate source API posting for conversational text. If there is no question or request, output nothing (no FELIX_REPLY).",
